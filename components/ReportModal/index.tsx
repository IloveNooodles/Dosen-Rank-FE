import { Container, VStack, Text, CheckboxGroup, Checkbox, Input, HStack, Button, Textarea, Flex, Spacer } from "@chakra-ui/react";
        ...
        <Flex
            ...
            <VStack
                ...
                <VStack
                    ...
                    <Spacer/>
                    <HStack width="full">
                        <Button onClick={props.onClose} variant="secondary" width="full">
                            Batal
                        </Button>
