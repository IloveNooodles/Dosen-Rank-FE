...
import { Button, FormLabel, Text, VStack, useToast } from '@chakra-ui/react';
      ...
      onSubmit={async (values) => {
        ...
        try {
          const response = await apiInstance({}).post(
            `/users/reset-password?token=${token}&email=${email}`,
            data
          );
      ...
      <Form>
        <VStack>
          ...
          <TextInput
            ...
            type="password"
          />
          <Button mt={4} colorScheme="teal" type="submit" width="24rem">
            Submit
          </Button>
